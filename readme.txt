...
You can can either go into the Support forum, or in the [WP Unique Media Repository](https://github.com//wp-unique-media).

= I'd like to suggest a feature. Where should I post it? =

I personally prefer GitHub. The plugin code is here: [GitHub](https://github.com//wp-unique-media)
(See above as well.)
...
3. type `git clone git@github.com:/wp-unique-media.git`
...
Either post it on the [GitHub-repo](https://github.com//wp-unique-media) or—if you cloned the repository—send me a pull request.
